...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Ноя 18 2024 г., 22:13
...
('6a3bm5oc32pcbp6ri49q6ufg06nuql5s', 1, 'admin', 1731956887, '67', 4);
...
('6a3bm5oc32pcbp6ri49q6ufg06nuql5s', 1, 1731956887, '127.0.0.1');
...
(53, 'document', 'text/html', 'Надёжный пылесос для работы', '', '', 'quam-quo-consequatur-vel-reprehenderit-et', '', 1, 0, 0, 7, 0, '', '<p>Эргономичный товар, обеспечивает высокий комфорт. Он экономит время, из экологически чистых материалов. Этот продукт экономит время.</p><p>Эргономичный товар, обеспечивает высокий комфорт. Он повышает продуктивность, с прочной металлической основой. Этот продукт повышает продуктивность.</p>', 1, 3, 13, 1, 1, 1, 1728756116, 1, 1731954763, 0, 0, 0, 1731954763, 0, '', 0, 0, 0, 0, 1, 1),
(54, 'document', 'text/html', 'Уникальный диван для дома', '', '', 'quam-qui-et-nobis', '', 1, 0, 0, 6, 0, '', '<p>Функциональный товар, обеспечивает высокий комфорт. Он подарит вам удобство, из натурального дерева. Этот продукт подарит вам удобство.</p><p>Высококачественный товар, удобен в использовании. Он долговечен и устойчив к повреждениям, с прочной металлической основой. Этот продукт долговечен и устойчив к повреждениям.</p>', 1, 3, 17, 1, 1, 1, 1728756116, 1, 1731954763, 0, 0, 0, 1731954763, 0, '', 0, 0, 0, 0, 1, 1),
...
(56, 'document', 'text/html', 'Стильный стол для работы', '', '', 'sapiente-inventore-reprehenderit-et-officia', '', 1, 0, 0, 4, 0, '', '<p>Устойчивый товар, компактен. Он подарит вам удобство, с прочной металлической основой. Этот продукт подарит вам удобство.</p><p>Функциональный товар, легко очищается. Он не теряет своих качеств с годами, с прочной металлической основой. Этот продукт не теряет своих качеств с годами.</p>', 1, 3, 1, 1, 1, 1, 1728756116, 1, 1731954763, 0, 0, 0, 1731954763, 0, '', 0, 0, 0, 0, 1, 1),
...
(95, 'document', 'text/html', 'Современный стул компактный', '', '', 'ducimus-quis-at-soluta-distinctio', '', 1, 0, 0, 4, 0, '', '<p>Износостойкий товар, легко очищается. Он не теряет своих качеств с годами, с прочной металлической основой. Этот продукт не теряет своих качеств с годами.</p><p>Устойчивый товар, отлично подходит для дома. Он экономит время, с прочной металлической основой. Этот продукт экономит время.</p>', 1, 3, 27, 1, 1, 1, 1728756116, 1, 1731954763, 0, 0, 0, 1731954763, 0, '', 0, 0, 0, 0, 1, 1),
(96, 'document', 'text/html', 'Уникальный стул премиум-класса', '', '', 'explicabo-et-beatae-voluptas-doloremque-est-ea', '', 1, 0, 0, 4, 0, '', '<p>Экологически чистый товар, предназначен для активного использования. Он долговечен и устойчив к повреждениям, из высококачественного пластика. Этот продукт долговечен и устойчив к повреждениям.</p><p>Долговечный товар, прост в сборке. Он повышает продуктивность, с мягкими текстильными покрытиями. Этот продукт повышает продуктивность.</p>', 1, 3, 28, 1, 1, 1, 1728756116, 1, 1731954763, 0, 0, 0, 1731954763, 0, '', 0, 0, 0, 0, 1, 1),
...
(250, 3, 104, '1'),
(251, 7, 104, '1'),
(252, 19, 2, '{\"fieldValue\":[{\"param_id\":\"9\",\"cat_name\":\"\",\"list_yes\":\"\",\"fltr_yes\":\"1\",\"fltr_type\":\"6\",\"fltr_name\":\"Цена\",\"fltr_many\":\"\",\"fltr_href\":\"\"},{\"param_id\":\"17\",\"cat_name\":\"\",\"list_yes\":\"1\",\"fltr_yes\":\"1\",\"fltr_type\":\"4\",\"fltr_name\":\"Бренж\",\"fltr_many\":\"\",\"fltr_href\":\"\"},{\"param_id\":\"18\",\"cat_name\":\"\",\"list_yes\":\"1\",\"fltr_yes\":\"1\",\"fltr_type\":\"1\",\"fltr_name\":\"Цвет\",\"fltr_many\":\"1\",\"fltr_href\":\"\"},{\"param_id\":\"20\",\"cat_name\":\"\",\"list_yes\":\"1\",\"fltr_yes\":\"1\",\"fltr_type\":\"2\",\"fltr_name\":\"Размер\",\"fltr_many\":\"\",\"fltr_href\":\"\"}],\"fieldSettings\":{\"autoincrement\":1}}'),
(256, 17, 27, '1'),
(257, 18, 27, '3'),
(258, 18, 15, '2'),
(259, 17, 15, '1'),
...
(1, 'admin', '$P$BhxwuOxPF0Hm1XIl7uHldIOLU4eyGu0', '', '874ddd8a2a5b2c03e5252f0b94cbea258eb8f84d7b31335e51755907ccdfd85d', '4b1c247ee90b0d8385f7f09f63dbe06efc9c9998a8e65d23ad304cfc6f692004', '2024-11-19 03:41:35', NULL);
...
(1, 1, '', NULL, NULL, NULL, 1, 'admin@local.local', '', '', 0, 0, 0, 6, 1731948094, 1731948094, 0, '1', 0, 0, '', '', '', '', '', '', '', NULL, 1728745019, 1731948095, 1);
