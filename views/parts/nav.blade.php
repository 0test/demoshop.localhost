<nav class="sticky-top navbar navbar-expand-lg navbar-dark bg-black">
    <div class="container">
        ...
        <a href="#" class="d-md-block d-none icon-link me-3" data-bs-toggle="modal" data-bs-target="#callmeModal">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-telephone me-1"
                viewBox="0 0 16 16">
                <path
